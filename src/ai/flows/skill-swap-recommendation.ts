...
Please analyze the profiles and provide up to {{numberOfRecommendations}} unique recommendations. It is crucial that you do not recommend the same user more than once.
...
4.  **Fill the List:** If you cannot find {{numberOfRecommendations}} strong matches, provide as many unique recommendations as you can find. Do not duplicate users to fill the list.

For each recommendation, provide only the user's ID.
